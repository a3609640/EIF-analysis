...
somatic_data = en.get_mutations()
print(somatic_data.columns)
...
sns.set_style("white")
sns.boxplot(x          = "Sample_Status",
            y          = "{}_proteomics".format(gene),
            data       = omics_mutations,
            showfliers = False)
sns.stripplot(x        = "Sample_Status",
              y        = "{}_proteomics".format(gene),
              data     = omics_mutations,
              color    = '.3')
plt.title('endometrial cancer')
...
#####
gene = 'EIF4EBP1'
omics_mutations = en.append_mutations_to_omics(omics_df_name  = "phosphoproteomics_gene",
                                               mutation_genes = gene,
                                               omics_genes    = gene)
omics_mutations.head()
sns.set_style("white")
...
sns.boxplot(x          = "Sample_Status",
            y          = "{}_phosphoproteomics_gene".format(gene),
            data       = omics_mutations,
            showfliers = False)
sns.stripplot(x        = "Sample_Status",
              y        = "{}_phosphoproteomics_gene".format(gene),
